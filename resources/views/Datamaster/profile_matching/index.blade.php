...
@section('content')
    <div class="container-fluid">
        ...
        <p class="mb-4">Berikut adalah hasil perhitungan ranking mahasiswa menggunakan metode <strong>Profile
                Matching</strong>.<br>
            <small class="text-muted">Total = (60% × NCF) + (40% × NSF)</small>
        </p>
        ...
        @if (empty($hasil) && empty($error))
            <div class="alert alert-info text-center">
                <i class="fas fa-info-circle"></i> Data belum tersedia. Silakan tambahkan data alternatif dan profile
                matching terlebih dahulu.
            </div>
        @endif
